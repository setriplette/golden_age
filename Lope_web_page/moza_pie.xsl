...
<!--    <xsl:variable name="doc" select="doc('Moza_tei.xml')"/>-->
    ...
    <xsl:template match="/">
        ...
        <svg width="100%" height="100%">
            ...
            <text x="-100" y="-200" fill="purple" font-size="24" font-family="avenir">La moza de cantaro</text>
                <text x="200" y="-100" fill="black" font-size="20" font-family="avenir">Legend</text>
                <text x="95" y="70" fill="black" font-size="20" font-family="avenir">55%</text>
                <text x="-128" y="-70" fill="black" font-size="20" font-family="avenir">45%</text>
                ...
                <text x="-200" y="170" fill="purple" font-size="18" font-family="avenir">Though the protagonist of the play is female, male characters outnumber </text>
                <text x="-200" y="200" fill="purple" font-size="18" font-family="avenir">female characters, accounting for their larger share of dialogue.</text>
