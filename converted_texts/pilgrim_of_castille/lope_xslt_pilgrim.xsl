...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="rs[@type='emotion']"><span class="emotion"><xsl:apply-templates/></span></xsl:template>
    ...
    <xsl:template match="floatingText"><span class="floating"><xsl:apply-templates/></span></xsl:template>
