...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>People of La moza de cántaro</title>
            ...
            <body>
                ...
                <div id="fieldset">
                    <fieldset>
                        ...
                        <span>Historical People</span>
                        <input type="checkbox" id="mythPerson"/>
                        <span>Mythological People</span>
                        <input type="checkbox" id="fictPerson"/>
                        <span>Fictional People</span>
                        <input type="checkbox" id="biblPerson"/>
                        <span>People relevant to the Bible or Christianity</span>
