    ...
    <xsl:template match="/">
        ...
        <svg width="500" height="500" viewBox="0 0 1000 1000">
            <g transform="translate(30, 500)">
                ...
                <xsl:variable name="yPos_bod" select="count($doc//rs[@type='body'][ancestor::sp[@who='#Otavio_boba']])"/>
                ...
                <text x="180" y="{-$yPos_bod * $ySpacer - 10}" fill="black" font-size="32" font-family="avenir"><xsl:value-of select="count($doc//rs[@type='body'][ancestor::sp[@who='#Otavio_boba']])"/></text>
                
                <xsl:variable name="yPos_emo" select="count($doc//rs[@type='emotion'][ancestor::sp[@who='#Otavio_boba']])"/>
                ...
                <text x="410" y="{-$yPos_emo * $ySpacer - 10}" fill="black" font-size="32" font-family="avenir"><xsl:value-of select="count($doc//rs[@type='emotion'][ancestor::sp[@who='#Otavio_boba']])"/></text>
