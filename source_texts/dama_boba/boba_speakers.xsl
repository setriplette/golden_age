    ...
    <xsl:template match="/">
        ...
        <svg width="1000" height="1100" viewBox="0 0 1000 1000">
            <g transform="translate(30, 500)">
                ...
                <line x1="30" y1="-450" x2="800" y2="-450" stroke="black" stroke-width="1"/>


                <text x="150" y="-400" fill="black" font-size="24" font-family="avenir">
                    Speeches by Character</text>
                <text x="200" y="-355" fill="purple" font-size="24" font-family="avenir">La dama
                    boba</text>
                <text x="140" y="-315" fill="black" font-size="16" font-family="avenir">Click bar for body and emotion by speaker</text>
